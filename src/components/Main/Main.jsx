...
const Main = () => {
  ...
  useEffect(() => {
    ...
    const searchSkills = async () => {
      const response = await fetch(
        `/users/profile/allUserSkillsFromSkills/${user.id}`
      );
    ...
    document
      .querySelectorAll(".ant-menu-item")[0]
  ...
  return (
    <div className="main-page">
      ...
      <h2>
        Я твой карьерный коуч. С моей помощью ты быстро построишь
        головокружительную карьеру!
      </h2>
      {/* Здесь нужно вставить проверку: если скилы не добавлены, выводить этот блок: */}
      <div className="profile-line">
        <p>
          В своем профиле ты можешь добавить или изменить информацию о себе, а
          также посмотреть рекомендации по предыдущим запросам:
        </p>
        <Button
          type="primary"
          shape="round"
      ...
      <div className="skills-line">
        {isLoading ? (
          ...
          <>
            <p>
              В твоем профиле уже есть навыки. Можешь добавить новые или
              изменить текущие по кнопке:
            </p>
            <Button
              type="primary"
              shape="round"
          ...
          <>
            <p>
              В твоем профиле еще нет навыков. Нужно их добавить, чтобы я смог
              рекомендовать тебе лучшие вакансии:
            </p>
      ...
      <div className="analize-line">
        {isLoading ? (
          ...
          <>
            {" "}
            <p>
              Попробуй проанализировать рынок вакансий - это самый мощный мой
              инструмент. Проведя анализ, мы с тобой поймем, какие навыки
              требуются работодателям, какие из них тебе нужно указать в резюме
              и портфолио, чтобы тебя точно взяли на работу!
            </p>
            <Button
              type="primary"
              shape="round"
          ...
          <>
            <p>Проведи новый анализ рынка вакансий, нажав на кнопку:</p>
            <Button
              type="primary"
              shape="round"
              icon={<FundTwoTone />}
