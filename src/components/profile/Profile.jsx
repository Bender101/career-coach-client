...
const Profile = () => {
  ...
  useEffect(() => {
    ...
    document
      .querySelectorAll(".ant-menu-item")[1]
        ...
        <div className="profile-container">
          ...
          <ul className="profile-settings">
            <li>
              ...
              <div style={{ width: "60%" }}>{user.name}</div>
              <div style={{ width: "10%" }} />
            </li>
            <li id="fio-edit">
              <div style={{ width: "30%" }}>Имя</div>
              <div style={{ width: "60%" }}>{user.fio || "Анонимус"}</div>
              <div style={{ width: "10%" }}>
                <Tooltip title="edit">
                  <Button
